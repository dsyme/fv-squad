...
Across 88 runs spanning $\approx$13 weeks, the agent produced:
\begin{itemize}\setlength\itemsep{0pt}
...
88 LLM agent runs (each $\sim$15--30 minutes of wall-clock time)
...
and produced 575 machine-checked theorems across 55 files in 88 runs,
